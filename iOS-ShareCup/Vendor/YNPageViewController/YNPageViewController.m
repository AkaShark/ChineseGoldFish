...
- (void)addViewControllerToParent:(UIViewController *)viewController index:(NSInteger)index {
    ...
    viewController.view.frame = CGRectMake(kYNPAGE_SCREEN_WIDTH * index, 0, self.pageScrollView.yn_width, KScreenHeight-25);
...
- (void)setupPageScrollMenuView {
    [self initPagescrollMenuViewWithFrame:CGRectMake(0, 0, self.config.menuWidth, KScreenHeight-25)];
}
